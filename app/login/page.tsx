...
export default function Login() {
      ...
      <div className="bg-white rounded-2xl p-8 w-full max-w-md shadow-2xl">
        {!showReset ? (
          <>
            ...
            <p className="text-gray-500 mb-6">Log in to your ShopCast account</p>
            ...
            <div className="flex flex-col gap-3 mb-6">
              <button onClick={handleGoogleLogin}
                className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-lg px-4 py-3 text-gray-700 font-medium hover:bg-gray-50 transition">
  ...
  <Link href="/privacy" className="text-blue-500 hover:underline">Privacy Policy</Link>
          ...
          <>
            <button onClick={() => setShowReset(false)} className="text-blue-600 text-sm mb-4 hover:underline">← Back to login</button>
